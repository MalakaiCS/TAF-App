...
MODULES = ["tests.test_rules", "tests.test_db_and_updates", "tests.test_orders",
           ...
           "tests.test_bulk_status",
           "tests.test_line_progress",
           "tests.test_recurring_jobs",
           "tests.test_customer_emails",
           "tests.test_margin",
           "tests.test_offline",
           "tests.test_web_audit",
           "tests.test_notify",
           "tests.test_features",
           "tests.test_cutting",
           "tests.test_insights",
           "tests.test_records",
           "tests.test_worksheet_pdf",
           "tests.test_macos",
           "tests.test_customer_match",
